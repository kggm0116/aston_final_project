package ru.kggm.feature_browse.presentation.ui.locations.list.filter
    ...
    private fun subscribeToViewModel() {
        lifecycleScope.launch {
            viewModel.filterParameters.collect { parameters ->
                with (parameters) {
                    runOnUiThread {
                        binding.inputTextLocationName.setTextKeepState(nameQuery ?: "")
                        binding.inputTextLocationType.setTextKeepState(type ?: "")
                        binding.inputTextLocationDimension.setTextKeepState(dimension ?: "")
                    }
                }
            }
        }
